...
def main():
    ...
    parser.add_argument("--embeddings", "-e", type=str, help="Path to trained model embeddings")
    parser.add_argument("-k", type=int, default=7, help="Number of folds for cross-validation")
    parser.add_argument("--output_dir", "-o", type=str, help="Directory to save fold data")
...
"""
For genecat pfam:
python src/scripts/process_embeddings_output.py -e src/data/embeddings/genecat_embeddings/model_gene_multilabel_untied_april_sriqcx3c_v0_context_embedding.embeddings.parquet -o src/data/results/genecat/fold_data_pfam

For genecat pfam+cazy:
python src/scripts/process_embeddings_output.py -e src/data/embeddings/genecat_embeddings/model_gene_multilabel_pfam_cazy_april_goycr91w_v0_context_embedding.embeddings.parquet -o src/data/results/genecat/fold_data_cazy
