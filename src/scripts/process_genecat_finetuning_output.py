...
pul_pred = "src/data/results/genecat_fine_tuned/logs_genecat_fine_tuned/wandb/latest-run/files/pul_predictions.h5ad"

adata = ad.io.read_h5ad(pul_pred)
...
labeled_table.write_csv(f"src/data/results/genecat_fine_tuned/labeled_results_test_0.tsv", separator='\t')
